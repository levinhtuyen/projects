...
<h1><a href="https://levinhtuyen.github.io/projects">Projects</a></h1>
...
Needed a way to display all my projects, used my [portfolio's project section](https://levinhtuyen.github.io/#projects) as inspiration.
...
```bash
git clone https://github.com/levinhtuyen/projects
cd projects
```
...
Open `index.html` in your favorite browser or visit [levinhtuyen.github.io/projects](https://levinhtuyen.github.io/projects).
...
<a href="https://github.com/levinhtuyen/projects">Source</a> | <a href="https://levinhtuyen.github.io/projects">Website</a>
